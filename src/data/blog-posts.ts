...
export const blogPosts: BlogPost[] = [
  {
    ...
    imageUrl: '/images/blog/blog-20260305-蔬果农药与健康-qhu92m.jpg',
    author: 'AskDrLiu.com'
  },
  ...
  },
  {
    ...
    seoTitle: '胆结石形成的原因及预防措施',
    seoDescription: '了解胆结石的形成机制与预防措施，包括饮食调整、控制体重与适量运动，从而显著降低患病风险。',
    date: '2025-03-15',
    category: '胆结石预防',
  ...
  },
  {
    ...
    seoTitle: 'POCS手术前后的饮食指导',
    seoDescription: '详细介绍POCS术后的饮食康复指南，从清淡流质饮食到均衡膳食的过渡，帮助患者快速恢复。',
    date: '2025-02-22',
    category: '饮食指导',
