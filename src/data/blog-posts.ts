...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: `胆囊切除后脂肪消化能力短期下降，可能影响脂溶性维生素A、D、E、K的吸收。本文从循证医学角度详解术后需要关注的维生素和微量元素，以及如何科学补充。`,
    excerptEn: `After gallbladder removal, reduced fat digestion may impair absorption of fat-soluble vitamins A, D, E, and K. This article explains evidence-based supplementation strategies for post-cholecystectomy patients.`,
    seoTitle: `胆囊切除术后需要补充哪些维生素和微量元素？肝胆外科医生详解`,
    seoDescription: `胆囊切除术后需要补充哪些维生素？肝胆外科医生详解术后脂溶性维生素A、D、E、K及钙、锌、铁等微量元素的科学补充方法，帮助患者快速恢复。`,
    date: '2026-04-28',
    category: '胆囊切除术后营养',
