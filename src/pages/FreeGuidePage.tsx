...
function FreeGuidePage() {
  ...
  return (
    <section className="bg-gradient-to-br from-primary-50 via-white to-blue-50 py-16 md:py-20">
      <div className="mx-auto max-w-5xl px-4 md:px-6">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="rounded-2xl border border-primary-200 bg-white p-6 shadow-soft md:p-8">
            ...
            <h1 className="mb-4 text-3xl font-bold text-primary-900 md:text-4xl">
              《胆囊切除术后营养注意要点》
            </h1>
